...
class Converter:
    ...
    def _pixel_to_node(self, pixel):
        ...
        """
        node = [
            int(((pixel[0]) / self._node_density) - 2),
    ...
    def _pixel_to_world(self, pixel):
        ...
        :return: world
        """
        relative_location = [pixel[0] * self._pixel_density, pixel[1] * self._pixel_density]
    ...
    def _world_to_pixel(self, world):
        ...
        pixel = [
            math.floor(relative_location[0] / float(self._pixel_density)),
