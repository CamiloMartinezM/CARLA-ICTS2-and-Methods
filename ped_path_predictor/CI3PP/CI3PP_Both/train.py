...
class CI3P_Both_Wrapper:
    def __init__(self, path=None):
        ...
        self.logger.info("Model: CI3P_Both_Wrapper")
...
if __name__ == "__main__":
    if "--test" in sys.argv:
        ...
        print("INT")
        print(
            f"&CI3P+(Cognitive+Car) & {int_1_a:.4f}/{int_1_f:.4f} & {int_2_a:.4f}/{int_2_f:.4f} & {int_3_a:.4f}/{int_3_f:.4f} & {int_4_a:.4f}/{int_4_f:.4f} & {int_5_a:.4f}/{int_5_f:.4f} & {int_6_a:.4f}/{int_6_f:.4f} \\\\",
        )
        print("NON-INT")
        print(
            f"&CI3P+(Cognitive+Car) & {non_int_1_a:.4f}/{non_int_1_f:.4f} & {non_int_2_a:.4f}/{non_int_2_f:.4f} & {non_int_3_a:.4f}/{non_int_3_f:.4f} & {non_int_4_a:.4f}/{non_int_4_f:.4f} & {non_int_5_a:.4f}/{non_int_5_f:.4f} & {non_int_6_a:.4f}/{non_int_6_f:.4f} \\\\",
        )
    else:
