...
class CVAE_CI3PP_Cog_Only_Wrapper:
    def __init__(self, path=None):
        ...
        self.logger.info("Model: SocialCi3pWrapperV3CVAE_COG_ONLY")
...
if __name__ == "__main__":
    if "--test" in sys.argv:
        abw_eval = CVAE_CI3PP_Cog_Only_Wrapper(
            path="./_out/SocialCi3pWrapperV3CVAE_COG_ONLY/obs15_pred20/2024-07-15_00-34-58/model_174.pth",
        )
        ...
        print("INT")
        print(
            f"&CI3P+(Cognitive+AS+CVAE) & {int_1_a:.4f}/{int_1_f:.4f} & {int_2_a:.4f}/{int_2_f:.4f} & {int_3_a:.4f}/{int_3_f:.4f} & {int_4_a:.4f}/{int_4_f:.4f} & {int_5_a:.4f}/{int_5_f:.4f} & {int_6_a:.4f}/{int_6_f:.4f} \\\\",
        )
        print("NON-INT")
        print(
            f"&CI3P+(Cognitive+AS+CVAE) & {non_int_1_a:.4f}/{non_int_1_f:.4f} & {non_int_2_a:.4f}/{non_int_2_f:.4f} & {non_int_3_a:.4f}/{non_int_3_f:.4f} & {non_int_4_a:.4f}/{non_int_4_f:.4f} & {non_int_5_a:.4f}/{non_int_5_f:.4f} & {non_int_6_a:.4f}/{non_int_6_f:.4f} \\\\",
        )
    else:
