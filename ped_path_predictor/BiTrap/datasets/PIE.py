...
class PIEDataset(data.Dataset):
    ...
    def get_traj_tracks(
        ...
        overlap_stride = max(overlap_stride, 1)
        ...
        for images, pids in zip(d["image"], d["pid"], strict=False):
