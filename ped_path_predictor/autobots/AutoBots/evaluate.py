...
class Evaluator:
        ...
        with torch.no_grad():
            ...
            for i, data in enumerate(self.val_loader):
                ...
                if self.interact_eval:
                    ...
                    scene_collisions, pred_obs, vehicles_only = collisions_for_inter_dataset(
                        pred_obs.cpu().numpy(),
                ...
                val_marg_mode_probs.append(
                    ...
                    .cpu()
                    .numpy()
                    .reshape(-1, self.model_config.num_modes),
                )
    ...
    def autobotego_evaluate(self):
        with torch.no_grad():
            ...
            print(
                f"minADE_{self.model_config.num_modes}:",
                val_minade_c[0],
                "minADE_10",
                val_minade_10[0],
                "minADE_5",
                val_minade_5[0],
                f"minFDE_{self.model_config.num_modes}:",
                val_minfde_c[0],
                "minFDE_1:",
                val_minfde_1[0],
            )
